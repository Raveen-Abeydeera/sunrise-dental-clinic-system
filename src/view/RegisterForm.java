...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (username.isEmpty() || password.isEmpty() || fullName.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Name, Username, and Password are required fields.", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        try {
            // Declare the variable AND call the controller inside the try block
            boolean isRegistered = controller.registerStaff(username, password, role, fullName, email);
            
            if (isRegistered) {
                javax.swing.JOptionPane.showMessageDialog(this, "Staff member " + fullName + " registered successfully as " + role + "!");
                this.dispose(); // Close form
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "Failed to create account. Username might already exist.", "Database Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            }
        } catch (IllegalArgumentException ex) {
            // Catches the weak password exception from the Controller
            javax.swing.JOptionPane.showMessageDialog(this, ex.getMessage(), "Weak Password Detected", javax.swing.JOptionPane.WARNING_MESSAGE);
        }
